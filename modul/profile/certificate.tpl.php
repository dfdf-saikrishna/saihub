...
for the amount of $ <strong>&nbsp;<?php echo $userId["product"][0]["value"];?> &nbsp;</strong> on <strong>&nbsp;<?php 
						...
						Serial No : <strong style="color:red; text-decoration:underline;"> <?php echo sprintf('%08d', $userId[0]['uid']); ?></strong>
						</div>
	...
	This is to certify that <strong style="color:red; text-decoration:underline;"> &nbsp; <?php echo $userId[0]['first_name'] . " " . $userId[0]['last_name']; ?> &nbsp;</strong> has donated one Shirdi Sai
	Baba Statue succeeding the emplacement related services to </br>
MYSAIWORLD PARK </br>
subject to terms and conditions stipulated to this certificate,  </br>
for the amount of $ <strong style="color:red; text-decoration:underline;"> &nbsp; <?php echo $userId["product"][0]["value"];?> &nbsp;</strong> on 
<strong style="color:red; text-decoration:underline;"> &nbsp; <?php 
						$yrdata= strtotime($userId["user"][0]["register_date"]);
						echo date('d M Y', $yrdata);
						?>&nbsp;</strong>.
						</div>
