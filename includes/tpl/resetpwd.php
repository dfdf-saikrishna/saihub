    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form>
                    <p>
                        Please provide your username to recover your password, we will send you an email for the new password.
                    </p>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="#"  class="btn btn-success btn-block btn-flat" id="reset">Recover My Password</a>
                            <a href="/login" class="btn btn-info btn-block btn-flat">Back To Sign In</a>
                        </div><!-- /.col -->
                    </div>
                </form>
